...
Society(int numPeople){
    ...
    public void diseasesAcquired()
{
     int num2 = (int) (Math.random() * 4) + 5;
     num2 = num2/10;
  for( int i = 0; i < population; i++)
  {
    if(people.get(i).getAge >= 80)
    {
        if(people.get(i).getChanceOfDisease() >= .45)
        {
          people.get(i).diseaseName() = diseases.diseases.get(3).getName();
          people.get(i).getDiseases() = true;
        }
    }
    ...
    if(people.get(i).getImmuneStrength() >= .35)
    {
        if(people.get(i).getChanceOfDisease() >= .45)
        {
            people.get(i).diseaseName() = diseases.diseases.get(5).getName();
            people.get(i).getDiseases() = true;
        }

        else  if(people.get(i).getChanceOfDisease() < .45)
        {
            people.get(i).diseaseName = "None";
        }
    }
    ...
    public void diseasesBornWith()
{
  ...
  for( int i = 0; i < population; i++)
  {
    ...
    public void cycleDay()
    {
        ...
        for(int i = 0; i < population; i++){
            if(people.get(i).getDiseases() = true){
                people.get(i).getTWD() = +1;
                people.get(i).getImmuneStrength() = -.0003;
            }
            if(people.get(i).diseaseName == "Cancer" || people.get(i).diseaseName == "Cerebrovascular Disease" && people.get(i).diseaseName == "Heart Disease")
            {
                if(people.get(i).getTWD <= 730)
                {
                    if(people.get(i).getImmuneStrength() >= .3){
                    people.get(i).markAsDeceased;
                    }
                    else{
                        people.get(i).getDiseases() = false;
                    }
                }
            }
            if(people.get(i).diseaseName == "Influenza" || people.get(i).diseaseName == "Diabetes" && people.get(i).diseaseName == "Kidney Disease")
            {
                if(people.get(i).getTWD >= 365)
                {
                    if(people.get(i).getImmuneStrength() >= .2){
                    people.get(i).markAsDeceased;
                    }
                    else{
                        people.get(i).getDiseases() = false;
             ...
             if(people.get(i).getHappiness() >= 20)
            {
                people.get(i).diseaseName = "Suicide";
                people.get(i).markAsDeceased;

            }

            if(people.get(i).getTWD >= 1460)
            {
                if(people.get(i).getAge >= 90){
                people.get(i).markAsDeceased;
                }
